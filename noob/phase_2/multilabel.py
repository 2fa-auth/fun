...
# многометочная классификация и метрики на бинарной задаче
...
def main():
  ...
  # print(f'logit.shape = {logit.shape}, target.shape = {target.shape}')
  ...
  exact_match_accuracy = 1 if label_wise_accuracy == 1. else 0
  print(f'точность модели с точки зрения попадания: {label_wise_accuracy}')
